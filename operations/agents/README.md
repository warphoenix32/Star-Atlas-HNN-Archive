...
The [Shared Operating Contract](SHARED-OPERATING-CONTRACT.md) applies to every role. The [Star Atlas Transcription Standard](STAR-ATLAS-TRANSCRIPTION-STANDARD.md) governs future machine-assisted transcript production, while the [Evidence Significance Standard](EVIDENCE-SIGNIFICANCE-STANDARD.md) governs transcript and conversational review without adding a fifth pipeline stage. On-demand specialists and their activation boundaries are defined in the [Specialist Registry](SPECIALIST-REGISTRY.md). The [Research and Gap Analyst](RESEARCH-GAP-ANALYST-CONTRACT.md) additionally owns the cross-source coverage register, acquisition backlog, and recurring-source freshness queue.
