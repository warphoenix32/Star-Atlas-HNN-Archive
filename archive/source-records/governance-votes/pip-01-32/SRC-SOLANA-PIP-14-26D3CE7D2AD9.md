# PIP-14 on-chain governance vote export

## Metadata

- Source ID: `SRC-SOLANA-PIP-14-26D3CE7D2AD9`
- PIP: `PIP-14`
- Proposal UUID: `fed98016-e7b6-4a5b-8120-4f0ec90cfa77`
- Proposal hash: `5dfd0b3f0c`
- Ballot mechanism: `BINARY_PVP`
- Vote events: 176
- Unique wallets: 176
- Total PVP: 108019015.52164
...
The record was extracted from `Star Atlas DAO PIP Votes/PIP-14.json` inside the operator-supplied archive. The archive is preserved unchanged at `archive/raw/governance-votes/pip-01-32/Star Atlas DAO PIP Votes.zip`.
