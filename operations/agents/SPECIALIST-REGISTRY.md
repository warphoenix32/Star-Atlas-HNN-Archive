...
| --- | --- | --- | --- |
| Transcript Hygiene Specialist | Ingested transcript text requires cleanup, speaker-boundary review, timestamp reconciliation, or recognition-quality assessment | Outputs conforming to the [Star Atlas Transcription Standard](STAR-ATLAS-TRANSCRIPTION-STANDARD.md), corrected derived transcript artifacts, correction and issue ledgers, validation report | Alter original captures; infer speakers from a candidate roster or voice similarity without review; promote knowledge |
