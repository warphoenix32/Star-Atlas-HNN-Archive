# PIP-13 on-chain governance vote export

## Metadata

- Source ID: `SRC-SOLANA-PIP-13-0BBFDD55D9D4`
- PIP: `PIP-13`
- Proposal UUID: `b721d8e7-9ca1-4a85-b627-472c108b3acb`
- Proposal hash: `07f60c5f0a`
- Ballot mechanism: `BINARY_PVP`
- Vote events: 161
- Unique wallets: 161
- Total PVP: 84911187.97101
...
The record was extracted from `Star Atlas DAO PIP Votes/PIP-13.json` inside the operator-supplied archive. The archive is preserved unchanged at `archive/raw/governance-votes/pip-01-32/Star Atlas DAO PIP Votes.zip`.
