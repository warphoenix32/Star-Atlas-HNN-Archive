# PIP-19 on-chain governance vote export

## Metadata

- Source ID: `SRC-SOLANA-PIP-19-C1959B9A1D5C`
- PIP: `PIP-19`
- Proposal UUID: `1eb3d15e-645e-4c34-8a69-00d304ecfc4f`
- Proposal hash: `24035117ee`
- Ballot mechanism: `BINARY_PVP`
- Vote events: 157
- Unique wallets: 157
- Total PVP: 143540402.94787
...
The record was extracted from `Star Atlas DAO PIP Votes/PIP-19.json` inside the operator-supplied archive. The archive is preserved unchanged at `archive/raw/governance-votes/pip-01-32/Star Atlas DAO PIP Votes.zip`.
