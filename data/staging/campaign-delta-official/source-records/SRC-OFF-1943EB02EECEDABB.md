# The Atlas Star ✧ Issue #4 | Star Atlas

## Metadata

- Source ID: `SRC-OFF-1943EB02EECEDABB`
- URL: https://experience.staratlas.com/newsroom/the-atlassian-newsletter/the-atlas-star-issue-4
- Publication date: 2021-07-15
- Updated date: UNKNOWN
- Original date text: Jul 15, 2021
...
Official economic report titled “The Atlas Star ✧ Issue #4 | Star Atlas.” This record preserves what Star Atlas Newsroom / ATMTA publicly stated at the recorded publication time; claims about delivery, economics, or outcomes remain limited to the wording of the source.
...
- The Atlas Star ✧ Issue #4 | Star Atlas Play Now Economic Reports White Paper • PDF Read Our Official White Paper!
...
- Coverage includes: Star Atlas Engineering Content A Note from the CRO’s desk A Note from the CPO’s desk Roadmap Updates & Media Related Activities Intro Down the road, our team is planning to release monthly devblogs to keep our community up to date and engaged with our software engineering team.
- To offer you a glimpse of what is to come, The Atlas Star ✧ this month is focused on our development efforts for the upcoming mini-game release and dives into some of the philosophy behind our technical vision and ambitions.
- DEX marketplace for Serum Enabling seamless in-app trading for your assets Michael Lu Tech Lead > I’m very excited to announce that the next major release of the mini-game will include a direct integration with Serum.
- It’s a lot of fun to imagine the dynamics that will emerge in our metaverse as a result of decentralization.
- There will be leaders in the universe, anarchists, even financial moguls who dominate entire markets.
- During internal discussions, the conversation has frequently come up regarding the dynamics of the in-game market and implications of how and when items get released.
- Once we’ve minted an item and released it into the world, the player is now the custodian of that item — not our team.
- In a trading card game, players will typically visit a store to purchase packs of cards.
- Unless our entire planet gets blown up, your items are there.
- This means no centralized servers executing game logic — it all happens on-chain.
- When Ethereum came out, it was groundbreaking and enabled users to not only trade digital currencies but to execute on-chain logic in the form of smart contracts.
- Then the ERC-20 and ERC-721 protocols were released as layers on top of Ethereum to accommodate for the user’s need to mint and trade their own tokens, backed by the strong foundation of the core token.
- The recently released ReBirth event is a great example of the first use case.
...
- https://play.staratlas.com/rebirth
- https://staratlas.com/
- http://play.staratlas.com/rebirth
- https://experience.staratlas.com/newsroom/the-atlassian-newsletter/star-atlas-to-sponsor-play-to-earn-game-festival
- https://experience.staratlas.com/newsroom/the-atlassian-newsletter/star-atlas-announces-nft-loot-box-rewards-drop-for-rebirth-meta-poster
- https://experience.staratlas.com/newsroom/the-atlassian-newsletter/the-atlas-star-issue-4
...
WIP interface layout /// Star Atlas design team /// Exclusive Preview
...
Rainbow Chi WIP /// Future Blockchain Based NFT In-Game Asset /// Owner/Player Builder Controlled
...
AI-enabled Usturn WIP /// Blockchain Based NFT In-Game Asset /// Owner/Player Builder Enabled
...
Deep Space Mining Landscape WIP /// Blockchain Based NFT In-Game Asset /// Owner/Player Controlled
...
The second use case is more applicable when we intend to release individual versions of the same item, especially for in-game items that have gameplay value. Let’s say there’s a ship that we release with a supply of 1000. The owners of that edition will now be the only holders of that specific version of the ship with its specific stats. In the future there might be game balancing changes on additional editions of that ship, but the people who own that original ship will
have it locked into the historical stats and value.
...
Pearce X4 Game Model WIP /// Blockchain Based In-Game NFT Asset /// Owner/Player Controlled
...
Prev
Star Atlas To Sponsor Play to Earn Game Festival
Next
