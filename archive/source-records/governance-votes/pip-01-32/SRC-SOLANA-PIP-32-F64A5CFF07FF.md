# PIP-32 on-chain governance vote export

## Metadata

- Source ID: `SRC-SOLANA-PIP-32-F64A5CFF07FF`
- PIP: `PIP-32`
- Proposal UUID: `0b04ff9b-ff04-45f5-a458-696fea70eda2`
- Proposal hash: `ceab9a1e81`
- Ballot mechanism: `BINARY_PVP`
- Vote events: 118
- Unique wallets: 118
- Total PVP: 119212364.30758
...
The record was extracted from `Star Atlas DAO PIP Votes/PIP-32.json` inside the operator-supplied archive. The archive is preserved unchanged at `archive/raw/governance-votes/pip-01-32/Star Atlas DAO PIP Votes.zip`.
