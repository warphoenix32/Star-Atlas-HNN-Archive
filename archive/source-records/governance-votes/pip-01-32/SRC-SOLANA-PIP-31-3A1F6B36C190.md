# PIP-31 on-chain governance vote export

## Metadata

- Source ID: `SRC-SOLANA-PIP-31-3A1F6B36C190`
- PIP: `PIP-31`
- Proposal UUID: `e71fb1a7-6d19-4565-8ff8-b4e79a3f8c16`
- Proposal hash: `839b710192`
- Ballot mechanism: `BINARY_PVP`
- Vote events: 141
- Unique wallets: 141
- Total PVP: 134547929.12659
...
The record was extracted from `Star Atlas DAO PIP Votes/PIP-31.json` inside the operator-supplied archive. The archive is preserved unchanged at `archive/raw/governance-votes/pip-01-32/Star Atlas DAO PIP Votes.zip`.
