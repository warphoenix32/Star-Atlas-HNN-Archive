# Destination Starbase: Rush Towards Prosperity in Star Atlas Intensifies | Star Atlas

## Metadata

- Source ID: `SRC-OFF-A49DE58EC808D004`
- URL: https://experience.staratlas.com/newsroom/star-atlas-news/destination-starbase-rush-towards-prosperity-in-star-atlas-intensifies
- Publication date: 2023-06-30
- Updated date: UNKNOWN
- Original date text: Jun 30, 2023
...
- Destination Starbase: Rush Towards Prosperity in Star Atlas Intensifies | Star Atlas Play Now Economic Reports White Paper • PDF Read Our Official White Paper!
- Back to top Star Atlas has begun a new phase on the path to SAGE, its iterative browser-based game release, with a reveal of a brand new kind of spaceships that equips players' fleets for gameplay in a real resource economy.
- As mining ships, the vessels will play a key role in the upcoming SAGE iteration that will introduce space resource extraction and crafting gameplay loops.
- Leading up to and following the next release of SAGE, these ships also have dual functionality through use in Faction Fleet and Faction Claims gameplay.
- As part of Destination Starbase, we are also releasing an upgrade to individual ship configurations of all vessels, deprecating the current configuration structure.
- Along with the current ship release, any new ship release will be released with V2 configs.
- Initially, at a 50% price discount, exactly 30% of the total supply of each of these ships for Tranche 1 is being made available for sale in the Galactic Marketplace.
- The total quantity for all three ships is divided into three tranches, each with its own price step: Tranche 1: 30% of the total ship quantity; 50% discount on the origination price Tranche 2: Another 30% of the total ship quantity; no discount on the origination price Tranche 3: The remaining 40% of the total ship quantity; 10% price premium on origination price For all three ships, only Tranche 1 is being released initially.
- Tranche 2 and possibly Tranche 3 for either of the individual ship models will become available either when a full tranche supply is sold out, or when the next SAGE gameplay module with resource extraction and crafting gets released --- whichever comes first.
...
- With the multi-phase Start Sequence through late 2022 and early 2023 and a subsequent Escape Velocity release, Star Atlas has been pursuing fast-paced development.
- In the future, this class of ships will play a vital role in the galactic economy.
- Ensuring that your civilization will build above and beyond, that your people will conquer the competition, and that you will realize your dreams of a better future.
- Ship Configuration Upgrade Until now, each ship available on the Galactic Marketplace has had a first-generation (V1) Ship Configuration that summarized its properties across the Crew, Components, and Modules categories.
- To achieve fully balanced gameplay within a real economy in the upcoming game releases, this system has been improved through a complete overhaul.
...
- https://staratlas.com/destination-starbase/brochure.pdf?utm_medium=medium&utm_campaign=s23c1
- https://play.staratlas.com/market/?category=structure&itemClass=stake%3Futm_medium%3Dmedium&utm_campaign=s23c1
- https://play.staratlas.com/fleet/?utm_medium=medium&utm_campaign=s23c1
- https://play.staratlas.com/claims/?utm_medium=medium&utm_campaign=S23c1
- https://play.staratlas.com/market/GmVKV9W3qZcERxk7hjqwRDcn9Kgtz3XDi7KfFLdGqyaW/?utm_medium=medium&utm_campaign=s23c1
- https://play.staratlas.com/market/ARNZXUQoBKx3JCX3UJB4aitSnvcjMMphN9YVDFy1PdKq/?utm_medium=medium&utm_campaign=s23c1
- https://play.staratlas.com/market/DTbNmLWfu1pm4AuXRKYTApnDNfxMz73VET7nW5wizG5t/?utm_medium=medium&utm_campaign=s23c1
- https://lore.staratlas.com/ship-manufacturers-configurations-and-politics/ship-configuration?utm_medium=medium&utm_campaign=s23c1
...
- https://experience.staratlas.com/newsroom/star-atlas-news/claim-your-destiny-the-dawn-of-the-player-driven-star-atlas-economy
- https://experience.staratlas.com/newsroom/star-atlas-news/new-star-atlas-state-of-the-economy-report-highlights-liberalization-of
- https://experience.staratlas.com/newsroom/star-atlas-news/destination-starbase-rush-towards-prosperity-in-star-atlas-intensifies
...
Ship
Daily ATLAS Emissions
Daily R4 Consumption
Fuel
Food
Toolkits
Ammo
Armstrong Industries IMP
1,107.84
31,690
28,168
2,347
Armstrong Industries IMP Tap
104.443
4,513
4,011
334
Armstrong Industries IMP Tip
36.235
1,404
1,248
104
Ship
Daily R4 Emissions
Faction Claims Cadence (in days)
Fuel
Food
Toolkits
Ammo
